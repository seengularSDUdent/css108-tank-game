...
public class Main extends Application {
			...
			scene.setOnKeyPressed((e) -> {
				switch (e.getCode()) {
					...
					case SPACE:
						...
						/*BulletTask bulletTask = new BulletTask(newPlayer, map);
	...
	public static void changePosition(GridPane gameField, MyPlayer newPos, Position prevPos, Map map, Pane root) {
